...
import 'package:maazim/main.dart'; // Ensure the main.dart has MyApp defined correctly
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
              ...
              onPressed: () async {
                ...
                QuickAlert.show(
                  ...
                  onConfirmBtnTap: () async {
                    // Call the sign-out method and then navigate to the main page
                    await FirebaseAuth.instance.signOut();
                    // Dismiss the QuickAlert dialog manually
                    Navigator.of(context, rootNavigator: true).pop();
                    // Now navigate to the main page, assuming 'MyApp' is the main widget of your app.
                    Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                          builder: (context) =>
                              MyApp()), // Replace MyApp with your main app widget if it's different.
