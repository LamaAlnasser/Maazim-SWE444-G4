...
class CoordinatorCredentialsGenerator {
  String generatePassword(int length) {
    ...
    return List.generate(length, (index) => charset[secureRandom.nextInt(charset.length)]).join();
  }
  ...
  Map<String, String> generateCredentials(String eventName, String eventId) {
    ...
    String password = generatePassword(8); // You can adjust the length as needed
