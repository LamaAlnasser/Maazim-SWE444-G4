...
import 'package:maazim/CoordinatorLogin.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(
                    height: 22,
                    child: Text(
                      'Crafting your perfect event journey.',
                      style: TextStyle(
                  ...
                  const SizedBox(height: 8), // New Button Added fot test..
                  // ElevatedButton(
                  //   onPressed: () => Navigator.push(
                  //     context,
                  //     MaterialPageRoute(
                  //         builder: (context) =>
                  //             CoordinatorLoginPage()), // Adjust to your actual page
                  //   ),
                  //   style: ElevatedButton.styleFrom(
                  //     minimumSize: Size(88, 36), // Smaller button size
                  //     textStyle: TextStyle(
                  //       fontSize: 16,
                  //       color: Color.fromARGB(255, 0, 0, 0),
                  //     ),
                  //   ),
                  //   child: Text('Entity Coordinator'),
                  // ),
