        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('/Users/alanoud/Desktop/Maazim-SWE444-G4/assets/white.png'), // Ensure the correct path
                fit: BoxFit.cover,
              ),
            ),
            child: SizedBox(
              height: MediaQuery.of(context).padding.top + 10, // Adjust the top space based on status bar height
            ),
          ),
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: const BorderRadius.vertical(top: Radius.circular(120.0), bottom: Radius.circular(0.0)),
              ),
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Image.asset(
                      '/Users/alanoud/Desktop/Maazim-SWE444-G4/assets/Logo.PNG', // Ensure the correct path
