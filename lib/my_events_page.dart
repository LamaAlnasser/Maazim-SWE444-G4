...
class _UpcomingEventsState extends State<UpcomingEvents> {
  ...
  void initState() {
    super.initState();
    eventsFuture = getUpcomingEvents();
  }
    ...
    try {
      ...
      if (user != null) {
        QuerySnapshot querySnapshot = await firestore
            ...
            .where('eventDateTime', isGreaterThan: Timestamp.now()) // Fetch upcoming events only
            .get();
    ...
    try {
      ...
      if (user != null) {
        QuerySnapshot querySnapshot = await firestore
          .collection('events')
          .where('userId', isEqualTo: user.uid)
          .where('eventDateTime', isLessThan: Timestamp.now()) // Fetch past events only
          .get();
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Text(
                                  "Invitees: ${event['numberOfInvitees']}",
                                  style: TextStyle(color: Colors.white),
                                ),
                              ),
                            ],
